        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <h5><?php echo $_GET['uname']?>'s Complaints</h5>
                        <hr>
...
$query=mysqli_query($con,"select tblcomplaints.*,users.fullName as name from tblcomplaints join users on users.id=tblcomplaints.userId where users.id='$userid'");
$cnt=1;
